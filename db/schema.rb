...
ActiveRecord::Schema.define(version: 2024_12_30_060543) do
  ...
  create_table "aws_s3s", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
    t.string "file_url"
